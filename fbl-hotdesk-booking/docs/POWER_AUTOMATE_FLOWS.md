...
day, desk, Curtin ID, or email.

**Trigger:** GET. Query parameters `date`, `deskId`, `email`, `staffId`
— all **optional**; apply only the ones that are present, as `and`
conditions in the filter query.
