(() => {
  ...
  function renderBookingsDateChips() {
    ...
    el("bookingsDateChips").querySelectorAll(".date-chip").forEach((btn) => {
      btn.addEventListener("click", () => {
        el("bookingsDateInput").value = btn.dataset.date;
  ...
  function syncBookingsDateChipHighlight() {
    const current = el("bookingsDateInput").value;
    el("bookingsDateChips").querySelectorAll(".date-chip").forEach((btn) => {
  ...
  async function searchBookings() {
    const date = el("bookingsDateInput").value;
    ...
    const rows = await Api.adminGetBookings({ date, deskId, email, staffId });
  ...
  el("bookingsDateInput").addEventListener("change", () => {
    syncBookingsDateChipHighlight();
  });
  el("bookingsClearBtn").addEventListener("click", () => {
    el("bookingsDateInput").value = isoDate(new Date());
